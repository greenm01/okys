...
const Accumulator = struct {
    ...
    direct_materialized_single_segment_alpha_tasks: usize = 0,
    direct_materialized_multi_segment_alpha_tasks: usize = 0,
    direct_materialized_invalid_segment_refs: usize = 0,
    ...
    fn add(
        ...
        self.direct_materialized_single_segment_alpha_tasks = direct_strip_stats.materialized_single_segment_alpha_tasks;
        self.direct_materialized_multi_segment_alpha_tasks = direct_strip_stats.materialized_multi_segment_alpha_tasks;
        self.direct_materialized_invalid_segment_refs = direct_strip_stats.materialized_invalid_segment_refs;
...
fn printResult(result: Accumulator) void {
    ...
    printIntField(result.direct_materialized_single_segment_alpha_tasks);
    printIntField(result.direct_materialized_multi_segment_alpha_tasks);
    printIntField(result.direct_materialized_invalid_segment_refs);
